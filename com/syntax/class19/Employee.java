...
public class Employee {
	...
	protected int age;// if class in the same package you can access all protected members
	double salary; // default - if class in the same package you can access all default members
	private long ssn;// only it is own class/same can have an access to private members

	public static void displatCompany() {
